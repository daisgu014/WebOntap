...
function todoItem({todo, index, editIndex}){
	...
	<div class="view">
		<input class="toggle"
		 ...
		 >
		<label ondblclick="dispacth('startEdit',${index})">${todo.title}</label>
	...
	<input class="edit" 
	value="${todo.title}"
	onkeyup="event.keyCode===13 && dispacth('endEdit',this.value.trim()) ||event.keyCode===27 && dispacth('cancelEdit')"
